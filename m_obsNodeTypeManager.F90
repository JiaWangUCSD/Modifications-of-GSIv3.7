...
! module interface:
  ...
  use obsmod, only: iobsType_refl  => i_refl_ob_type
  ...
  use m_reflNode , only:  reflNode ! 37
  ...
  type(   reflNode), target, save::    refl_mold ! 37
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
function vname2index_(vname) result(index_)
  ...
  case("refl" , "[reflnode]"); index_ = iobsType_refl
...
function vmold2index_select_(mold) result(index_)
  ...
  type is( reflNode); index_ = iobstype_refl
...
function index2vmold_(i_obType) result(obsmold_)
  ...
  case(iobsType_refl ); obsmold_ =>    refl_mold
