...
! module interface:
  ...
  use m_reflNode, only: reflNode   ! 40
  ...
  type obsHeadBundle
    ...
    class(obsNode),pointer::  refl => null()   ! 40
...
subroutine init_(yobs,ibin)
  ...
  use m_obsdiags, only:  reflhead       ! =40
  ...
  yobs%refl  => obsLList_headNode( reflhead(ibin))    ! =40
return
