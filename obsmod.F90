...
! set subroutines and functions to public
  ...
  public :: i_spd_ob_type,i_rw_ob_type,i_refl_ob_type,i_dw_ob_type,i_sst_ob_type
...
! Declare types
  ...
  integer(i_kind),parameter:: i_refl_ob_type=39   ! refl_ob_type
...
!   Define a name for obs types
    ...
    cobstype(i_refl_ob_type) ="reflectivity        " ! refl_ob_type
